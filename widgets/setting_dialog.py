...
class SettingDialog(QtWidgets.QDialog, Ui_Dialog):
    ...
    def get_item_and_widget(self, category, color: str):
        ...
        delete_button.setText('delete' if self.mainwindow.cfg['language'] == "en" else "删除")
    ...
    def import_cfg(self):
        file, _ = QtWidgets.QFileDialog.getOpenFileName(self, filter='yaml File(*.yaml)', directory="./settings")
        if file:
    ...
    def export_cfg(self):
        file, _ = QtWidgets.QFileDialog.getSaveFileName(self, filter='yaml File(*.yaml)', directory="./settings")
    ...
    def apply(self):
        ...
        for index in range(self.category_list_widget.count()):
            ...
            cfg["language"] = self.mainwindow.cfg["language"]
